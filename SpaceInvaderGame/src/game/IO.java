...
public class IO {
	 ...
	 * char-Array zurück, dessen Elemente die einzelnen Zeichen der Datei
	...
	/**
	 * Liest die im Parameter angegebene Textdatei aus und liefert ein
	 * zwei-dimensionale char-Array zurück, dessen Elemente die Zeichen der
	...
	/**
	 * Liest die im Parameter angegebene Textdatei aus und liefert ein
	 * String-Array zurück, dessen Elemente die einzelnen Zeilen der Datei
	 * enthalten
	 * 
	 * @param filename
	 *            Name der auszulesenden Datei
